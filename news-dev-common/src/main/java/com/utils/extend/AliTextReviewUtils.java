...
/**
 * @author Json
 * @date 2021/2/11 20:29
 */
@Component
public class AliTextReviewUtils {

    private static final Logger logger = LoggerFactory.getLogger(AliTextReviewUtils.class);

    private final AliyunResource aliyunResource;

    @Autowired
    public AliTextReviewUtils(AliyunResource aliyunResource) {
        this.aliyunResource = aliyunResource;
    }

    public String reviewTextContent(String content) {
        IClientProfile profile = DefaultProfile.getProfile("cn-shanghai", aliyunResource.getAccessKeyId(), aliyunResource.getAccessKeySecret());
